...
<body>
    ...
    <!-- Home Page
    ==========================================-->
    <div id="tf-Article3" class="text-center img-responsive">
    ...
    <div id="tf-about" class="img-responsive">
    	...
    	<div class="container" id="1">
    		<div class="section-title center">
               <a href="Article2.php#1" class="glyphicon glyphicon-chevron-left" style="font-size: 50px; left:15%; top:60px;" ></a>
               <a href="Article4.php#1" class="glyphicon glyphicon-chevron-right" style="font-size: 50px; left:110%; margin-left:-37.5%; top:58px;" ></a>
               <h2 class="text-center"><strong>Tom Mason</strong></h2>
               <h3 class="text-center"><strong>(Noah Wyle)</strong></h3>
            ...
            <div class="jumbotron" style="height:10%;">
                <img class="scarlett" src="../img/perso/profil/tom.jpg" style="width: 25%; float: left; ">
                <p>Il était, avant l'attaque, professeur d'histoire à Boston. Il met ses connaissances de l'histoire de la guerre à profit dans la résistance face aux extraterrestres. Sa femme est morte lors de l'attaque des extraterrestres et son fils Ben a été enlevé par ceux-ci. Tom Mason cherche deuis à le récupérer à tout prix et à protéger ses deux fils restants (Hal et Matt) de l'ennemi. À la fin de la première saison, il décide de rejoindre les extraterrestres pour sauver son fils Ben.
                    Il est né à Cambridge, Massachusetts et devient le commandant en second de la 2de division.
                    Dans la troisième saison, il devient le président des États-Unis dont la capitale et seule ville est Charleston.</p>
