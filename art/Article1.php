...
<body>
    ...
    <!-- Home Page
    ==========================================-->
    <div id="tf-Article1" class="text-center img-responsive">
    ...
    <div id="tf-about" class="img-responsive">
    	...
    	<div class="container" id="1">
    		...
    		<div class="section-title center" >
                ...
                <a  href="Article1.php#1" class="glyphicon glyphicon-chevron-left" style="font-size: 50px; left:15%; top:60px;" ></a>
                <a  href="Article2.php#1" class="glyphicon glyphicon-chevron-right"  style="font-size: 50px; left:110%; margin-left:-37.5%; top:58px;" ></a>

                <h2 class="text-center"><strong>Matt Mason</strong></h2>
                <h3 class="text-center"><strong>(Maxim Knight)</strong></h3>
             ...
             <div class="jumbotron">
                <img class="scarlett" src="../img/perso/profil/matt.jpg" style="width:23%; float: left;">
                <p>Le plus jeune des fils de Tom Mason. Dans les deux premières saisons, il essaie de se rendre utile malgré son jeune âge. Dans la troisième saison, ayant grandi, il est plus actif et sert en tant qu'éclaireur et en tant que ravitailleur dans les forces armées de Charleston. Il fréquente de temps à autre la bande de John Pope, ce qui lui fait développer un tempérament rebelle et occasionne parfois quelques conflits avec son père.</p>
