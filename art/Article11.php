...
<body>
    ...
    <!-- Home Page
    ==========================================-->
    <div id="tf-Article11" class="text-center img-responsive">
    ...
    <div id="tf-about" class="img-responsive">
    	...
    	<div class="container" id="1">
    		<div class="section-title center">
               <a href="Article10.php#1" class="glyphicon glyphicon-chevron-left" style="font-size: 50px; left:15%; top:60px;" ></a>
               <a href="Article12.php#1" class="glyphicon glyphicon-chevron-right" style="font-size: 50px; left:110%; margin-left:-37.5%; top:58px;" ></a>
               <h2 class="text-center"><strong>Lexis Mason</strong></h2>
               <h3 class="text-center"><strong>Scarlett byrne</strong></h3>
            ...
            <div class="jumbotron" >
                <img class="scarlett" src="../img/perso/profil/scarlett.jpg" style="float:left;">
                <p>Fille de Ann et Tom Mason. Durant sa gestation, son code ADN sera manipulé par les Esphenis ce qui lui octroie un rythme de croissance accéléré et des pouvoirs télékinésiques, ainsi que des cheveux blancs. Selon les Esphenis, elle aurait le potentiel d'une déesse vivante, plus puissante que toutes les armes dont ils disposent. Elle crée, au début de la quatrième saison, un havre de paix apparemment protégé de toute attaque Esphenis dans l'ancienne « Chinatown ». Elle est vénérée comme une guide spirituelle par les humains qui y vivent après avoir arrêté un mécha avec la foudre, sans aucune autre aide ni arme. Toutefois, Ann découvre qu'elle est en réalité manipulée par un Espheni qu'elle considère comme son père véritable. Se rendant compte petit à petit de cette manipulation dans un sinistre but, elle décide d'aider Tom Mason, son véritable géniteur, à détruire le générateur d'énergie Espheni qui se trouvait sur la Lune, éliminant au passage deux commandants Esphenis, dont son précepteur, réalisant qu'elle aimait plus Tom Mason en tant que père. Elle se sacrifie pour cela avec l'un des deux vaisseaux qu'elle et son père ont volés au Esphenis.</p>
