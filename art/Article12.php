...
<body>
    ...
    <!-- Home Page
    ==========================================-->
    <div id="tf-Article12" class="text-center img-responsive">
    ...
    <div id="tf-about" class="img-responsive">
    	...
    	<div class="container" id="1">
    		<div class="section-title center">
             <a href="Article11.php#1" class="glyphicon glyphicon-chevron-left" style="font-size: 50px; left:15%; top:60px;" ></a>
             <a href="Article12.php#1" class="glyphicon glyphicon-chevron-right" style="font-size: 50px; left:110%; margin-left:-37.5%; top:58px;" ></a>
             <h2 class="text-center"><strong>Cochise</strong></h2>
            ...
            <div class="jumbotron">
                <img class="scarlett" src="../img/perso/I12.jpg" style="float:left;">
                <p>Volm faisant office d'intermédiaire entre sa propre race et celle des humains. Surnommé ainsi en référence au chef apache et en contraction de son véritable nom (Cheechock il Sneetch-nitch Chatico), il est supposé être un leader de la résistance Volm contre les Esphenis. Il apparaît régulièrement dans la troisième saison puisqu'il prend part aux réunions tactiques et participe aux décisions militaires et d'infiltration. Il est régulièrement en conflit avec son père quand au sort de la race humaine, préférant les aider dans leur lutte plutôt que de s'occuper en priorité de reconquérir son monde natal.</p>
