...
<body>
    ...
    <!-- Home Page
    ==========================================-->
    <div id="tf-Article2" class="text-center img-responsive">
    ...
    <div id="tf-about" class="img-responsive">
    	...
    	<div class="container" id="1">
    		<div class="section-title center" >
                ...
                <a href="Article3.php#1" class="glyphicon glyphicon-chevron-right" style="font-size: 50px; left:110%; margin-left:-37.5%; top:58px;" ></a>
                <h2 class="text-center"><strong>Hal Mason</strong></h2>
                <h3 class="text-center"><strong>(Drew Roy)</strong></h3>
                ...
                <div class="jumbotron" style="height: 900px; ">
                    <img class="scarlett" src="../img/perso/profil/all.jpg" style="width: 25%; float: left">
                    <P>Fils aîné de Tom Mason. Il a seize ans et vivait à Somerville avant l'attaque. Il fut membre de l'équipe de football de son lycée, il est combattant au côté de son père. Dans la saison 3, on découvre qu'il est paralysé des jambes et qu'il se déplace en fauteuil roulant. Il en récupérera toutefois pleinement l'usage après s'être débarrassé du mouchard et de son influence.</P>
                    <img class="scarlett2" src="../img/perso/profil/all2.png" style="width: 28%; float: left">
