...
<body>
    ...
    <!-- Home Page
    ==========================================-->
    <div id="tf-Article8" class="text-center img-responsive">
    ...
    <div id="tf-about" class="img-responsive">
    	...
    	<div class="container" id="1">
    		<div class="section-title center">
                <a href="Article7.php#1" class="glyphicon glyphicon-chevron-left" style="font-size: 50px; left:15%; top:60px;" ></a>
                <a href="Article9.php#1" class="glyphicon glyphicon-chevron-right" style="font-size: 50px; left:110%; margin-left:-37.5%; top:58px;" ></a>
                <h2 class="text-center"><strong>John Pope</strong></h2>
                <h3 class="text-center"><strong>(Colin Cunningham)</strong></h3>
