...
<body>
    ...
    <!-- Home Page
    ==========================================-->
    <div id="tf-Article6" class="text-center img-responsive">
    ...
    <div id="tf-about" class="img-responsive">
    	...
    	<div class="container" id="1">
    		<div class="section-title center">
               <a href="Article5.php#1" class="glyphicon glyphicon-chevron-left" style="font-size: 50px; left:15%; top:60px;" ></a>
               <a href="Article7.php#1" class="glyphicon glyphicon-chevron-right" style="font-size: 50px; left:110%; margin-left:-37.5%; top:58px;" ></a>
               <h2 class="text-center"><strong>Ben Mason</strong></h2>
               <h3 class="text-center"><strong>(Connor Jessup)</strong></h3>
            ...
            <div class="jumbotron">
                <img class="scarlett" src="../img/perso/profil/ben.png" style="width: 28%; float: left;" >
                <p>Fils cadet de Tom Mason, enlevé dans la première saison, il joue un rôle principal dans la deuxième saison. À la suite de son enlèvement, après le retrait de son harnais, il développe des facultés extrasensorielles et suscite la méfiance des résistants. Il entretient également un rapport conflictuel avec son frère ainé Hal.</p>
