...
<body>
    ...
    <!-- Home Page
    ==========================================-->
    <div id="tf-Article4" class="text-center img-responsive">
    ...
    <div id="tf-about" class="img-responsive">
    	...
    	<div class="container" id="1">
    		<div class="section-title center">
             <a href="Article3.php#1" class="glyphicon glyphicon-chevron-left" style="font-size: 50px; left:15%; top:60px;" ></a>
             <a href="Article5.php#1" class="glyphicon glyphicon-chevron-right" style="font-size: 50px; left:110%; margin-left:-37.5%; top:58px;" ></a>
             <h2 class="text-center"><strong>Lourdes</strong></h2>
             <h3 class="text-center"><strong>(Seychelle Gabriel)</strong></h3>
            ...
            <div class="jumbotron">
                <img class="scarlett" src="../img/perso/profil/Lourdes.jpg" style="width: 26%; float: left;">
                <P>Étudiante en première année de médecine à Wellesley avant l'attaque, elle aide maintenant Anne Glass dans son infirmerie. Ses deux parents sont morts lors de l'attaque. Très croyante, elle est attentive aux autres. Dans la troisième saison, elle devient, à cause d'un mouchard implanté dans le corps, l'espionne meurtrière des Esphenis.</P>
