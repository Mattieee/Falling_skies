...
<head>
	...
	<title>Espace admin | Edit Page</title>
	<!-- Bootstrap core CSS -->
...
<body>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div class="col-md-10">
					<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Edit Page <small>Fallingskies.com</small></h1>
				</div>
				<div class="col-md-2">
						...
						<div class="panel-body">
							<form>
								...
								<div class="form-group">
									...
									<textarea name="editor1" class="form-control" placeholder="Page Title">
										slkdfjksjfdlksjflsdkfjslkfdjslfkjslkdfjsldfkjsdlkfjsldkfjslkfjsdlkfjslfkjsdkfjslkfjslkdfjslkfjslkff
									</textarea>
								</div>
								<div class="checkbox"> 
									<label>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Add Meta Description..." value="slkdfjksjfdlksjflsdkfjslkfdjslfkjslkdfjsldfkjsdlkfjsldkfjslkfjsdlkfjslfkjsdkfjslkfjslkdfjslkfjslkff">
								</div>
