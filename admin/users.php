...
<head>
	...
	<title>Espace admin | Users</title>
	<!-- Bootstrap core CSS -->
...
<body>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				<div class="col-md-10">
					<h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Users <small>Fallingskies.com</small></h1>
				</div>
				<div class="col-md-2">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<table class="table table-striped table-hover">
								...
								<tr>
									<td>Matthieu Royer</td>
									<td>Matthieu.royer78@gmail.com</td>
									<td>Mai 09, 2017</td>
								</tr>
								<tr>
									<td>Matthieu Royer</td>
